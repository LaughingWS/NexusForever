...
namespace NexusForever.WorldServer.Script.Creature.Transporters
{
    ...
    public class TeleportTo_StormcallerLanding : CreatureScript
    {
        const ushort WORLD_LEVIAN_BAY = 1387;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            player.TeleportTo(WORLD_LEVIAN_BAY, LOC_STORMCALLER_LANDING.X, LOC_STORMCALLER_LANDING.Y, LOC_STORMCALLER_LANDING.Z, reason: TeleportReason.Relocate);
        }
    }
}
