...
{ 
    ...
    public class TheExaniteForgesMessageTriggerScript : IGridEntityScript, IOwnedScript<IGridTriggerEntity>
    {
        ...
        public void OnEnterRange(IGridEntity entity)
        {
            ...
            ICommunicatorMessage message = globalQuestManager.GetCommunicatorMessage(CommunicatorMessage.AvraDarkos8);
