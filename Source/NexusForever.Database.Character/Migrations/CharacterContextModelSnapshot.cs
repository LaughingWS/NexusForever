...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterContactModel", b =>
                {
                    ...
                    b.ToTable("character_contact", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterPathEpisodeModel", b =>
            {
                ...
                b.HasKey("Id", "EpisodeId")
                    .HasName("PRIMARY");
                b.ToTable("character_path_episode");
            });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterPathMissionModel", b =>
            {
                ...
                b.HasKey("Id", "EpisodeId", "MissionId")
                    .HasName("PRIMARY");
                b.ToTable("character_path_mission");
            });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterRewardTrackMilestoneModel", b =>
                {
                    ...
                    b.ToTable("character_reward_track_milestone", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterRewardTrackModel", b =>
                {
                    ...
                    b.ToTable("character_reward_track", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.ItemRuneModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.Property<uint?>("RuneItemId")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("runeItemId");

                    b.Property<byte>("RuneType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(3) unsigned")
                        .HasDefaultValue((byte)0)
                    ...
                    b.ToTable("item_rune", (string)null);
                });
