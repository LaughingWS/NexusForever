    ...
    public partial class AccountRewardTrack : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "id",
                keyValue: (byte)1,
                columns: new[] { "host", "name", "port" },
                values: new object[] { "127.0.0.1", "NexusForever", (ushort)24000 });

            migrationBuilder.UpdateData(
                table: "server_message",
                keyColumns: new[] { "index", "language" },
                keyValues: new object[] { (byte)0, (byte)0 },
                column: "message",
                value: @"Welcome to this NexusForever server!
Visit: https://github.com/NexusForever/NexusForever");

            migrationBuilder.UpdateData(
                table: "server_message",
                keyColumns: new[] { "index", "language" },
                keyValues: new object[] { (byte)0, (byte)1 },
                column: "message",
                value: @"Willkommen auf diesem NexusForever server!
