namespace NexusForever.Shared.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ClientExplorerPlaceSignal       = 0x00F3,
        ...
        ServerSettlerBuildResult        = 0x066C,
        ServerSettlerImprovementGroups  = 0x066D,
        ServerSettlerHubStatus          = 0x066E,
        ClientSettlerBuildImprovement   = 0x0670,
        ServerSettlerBuildStatus        = 0x0671,
        ...
        Server08B3                      = 0x08B3,
        ServerSettlerImprovementInfo    = 0x08B6,
        ServerSettlerHubUpdate          = 0x08B7,
