...
namespace NexusForever.Database.World.Migrations
{
    ...
    [Migration("20241025014601_EntityTemplate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.EntityTemplateModel", b =>
                {
                    b.Property<uint>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(10) unsigned")
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.EntityTemplatePropertyModel", b =>
                {
                    b.Property<uint>("Id")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("id");
                    ...
                    b.ToTable("entity_template_property", (string)null);
                });

            modelBuilder.Entity("NexusForever.Database.World.Model.EntityTemplateStatModel", b =>
                {
                    b.Property<uint>("Id")
                        .HasColumnType("int(10) unsigned")
                        .HasColumnName("id");
                    ...
                    b.ToTable("entity_template_stat", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.World.Model.EntityTemplatePropertyModel", b =>
                {
                    b.HasOne("NexusForever.Database.World.Model.EntityTemplateModel", "Entity")
                        .WithMany("EntityProperty")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
